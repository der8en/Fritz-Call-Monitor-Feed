...
Der Teil "sensor.fritz_box_7590_ax_anrufmonitor_telefonbuch" muss überall an den **eigenen Entitätsnamen angepasst** werden!
...
- id_filter: ^home_feed_.* _(damit nur Anruf-Benachrichtigungen angezeigt werden)_
