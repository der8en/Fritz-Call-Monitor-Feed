...
Der Trigger "klingelt" mit ID 2 hat eine mindest Klingeldauer von 2 Sekunden. Wird diese Zeit reduziert/entfernt, werden geblockte Anrufer als verpasster Anruf angezeigt.
